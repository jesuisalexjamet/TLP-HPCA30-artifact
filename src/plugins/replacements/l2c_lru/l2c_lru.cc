...
#
#include <plugins/replacements/l2c_lru/l2c_lru.hh>
 ...
 */
cr::l2c_lru_replacement_policy::l2c_lru_replacement_policy () {
...
void cr::l2c_lru_replacement_policy::update_replacement_state (const ch::cache_access_descriptor& desc) {
...
std::size_t cr::l2c_lru_replacement_policy::find_victim (const ch::cache_access_descriptor& desc) {
 ...
 */
cr::ireplacementpolicy* cr::l2c_lru_replacement_policy::create_replacementpolicy () {
	return new cr::l2c_lru_replacement_policy ();
}

void cr::l2c_lru_replacement_policy::_init (const pt::ptree& props, cc::cache* cache_inst) {
