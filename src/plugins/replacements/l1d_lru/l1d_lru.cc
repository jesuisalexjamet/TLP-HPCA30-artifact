...
#
#include <plugins/replacements/l1d_lru/l1d_lru.hh>
 ...
 */
cr::l1d_lru_replacement_policy::l1d_lru_replacement_policy () {
...
void cr::l1d_lru_replacement_policy::update_replacement_state (const ch::cache_access_descriptor& desc) {
...
std::size_t cr::l1d_lru_replacement_policy::find_victim (const ch::cache_access_descriptor& desc) {
 ...
 */
cr::ireplacementpolicy* cr::l1d_lru_replacement_policy::create_replacementpolicy () {
	return new cr::l1d_lru_replacement_policy ();
}

void cr::l1d_lru_replacement_policy::_init (const pt::ptree& props, cc::cache* cache_inst) {
