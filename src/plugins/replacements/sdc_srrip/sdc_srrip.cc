...
#
#include <plugins/replacements/sdc_srrip/sdc_srrip.hh>
 ...
 */
cr::sdc_srrip_replacement_policy::sdc_srrip_replacement_policy () {
...
void cr::sdc_srrip_replacement_policy::update_replacement_state (const ch::cache_access_descriptor& desc) {
...
std::size_t cr::sdc_srrip_replacement_policy::find_victim (const ch::cache_access_descriptor& desc) {
	while (true) {
 ...
 */
cr::ireplacementpolicy* cr::sdc_srrip_replacement_policy::create_replacementpolicy () {
	return new cr::sdc_srrip_replacement_policy ();
}

void cr::sdc_srrip_replacement_policy::_init (const pt::ptree& props, cc::cache* cache_inst) {
